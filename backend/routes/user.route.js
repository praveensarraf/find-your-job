...
import { login, logout, register,updateProfile, changePassword, addBookmark, removeBookmark, getBookmarks, deleteAccount } from '../controllers/user.controller.js';
...
router.route("/profile/update").put(isAuthenticated, uploadFields, updateProfile);
